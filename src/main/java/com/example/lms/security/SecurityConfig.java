        ...
        return http.csrf(AbstractHttpConfigurer::disable)
                ...
                .authorizeHttpRequests(req ->
                        req.requestMatchers("/api/delete-user/**","/api/auth/**", "/v3/api-docs/**", "/swagger-ui/**","/api/test/public").permitAll()
                                ...
                                .requestMatchers("/api/test/updateTransactions","/api/transactions/member/**","/api/transactions/request/**","/api/book-request/pending","/api/book-request/*/approve","/api/dashboard/**").hasRole("ADMIN")
